...
export default function Freetoken() {
    return (
        <div id="Web_1920__11">
            ...
            <svg className="Path_2_bu" viewBox="2 9.33 52.787 45.293">
                <linearGradient
                    id="Path_2_bu"
                    spreadMethod="pad"
                    x1="0.5"
            ...
            <div id="You_just_completed_your_profil">
                <span>
                    You just completed your profile. Here’s XXX free tokens for
                    you!
                    <br />
                    <br />
                    Accept?
