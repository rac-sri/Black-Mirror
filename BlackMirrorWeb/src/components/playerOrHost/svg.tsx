...
export interface phSVGProps {}

const phSVG: React.SFC<phSVGProps> = () => {
    return (
        <>
            <svg className="Rectangle_491">
                <rect
                    id="Rectangle_491"
                    rx={40}
                    ry={40}
            ...
            <svg className="Path_2_bv" viewBox="2 9.33 52.787 45.293">
                <linearGradient
                    id="Path_2_bv"
                    spreadMethod="pad"
                    x1="0.5"
